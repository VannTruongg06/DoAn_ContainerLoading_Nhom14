...
g++ -std=c++17 scripts/benchmark.cpp src/dataset_loader.cpp src/knapsack_algorithms.cpp src/packing_algorithms.cpp src/meta_heuristics.cpp -Isrc -o benchmark.exe

echo  - Compiling smart_benchmark.exe...
g++ -std=c++17 scripts/smart_benchmark.cpp src/dataset_loader.cpp src/knapsack_algorithms.cpp src/packing_algorithms.cpp src/meta_heuristics.cpp -Isrc -o smart_benchmark.exe
